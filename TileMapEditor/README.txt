...
To run the Level Creator:
Double click TileMapEditor720p.jar for a 1280 by 720 display
Double click TileMapEditor1080p.jar for a 1920 by 1080 display

When it starts up, there is no loaded tileset. 
First thing to do is Ctrl + b, then type in the tiles file you want to use
